# -*- coding:utf-8 -*-
import re
from luhu_biz.orm.pay.charge import Charge
...
class TransactionLog(BaseModel):
    __tablename__ = 'mishi_transaction_log'
    __table_args__ = {}
    __bind_key__ = 'mishi'
...
class Transaction(BaseModel):
    __tablename__ = 'mishi_transaction'
    __table_args__ = {}
    __bind_key__ = 'mishi'
    ...
    def _after_insert(self):
        log = TransactionLog()
        for attr in ['phone', 'amount', 'status', 'pay_type', 'object_type', 'object_id', 'memo', 'pay_time',
...
class TransactionExtraInfo(BaseModel):
    __tablename__ = 'mishi_transaction_extra_info'
    __table_args__ = {}
    __bind_key__ = 'mishi'
