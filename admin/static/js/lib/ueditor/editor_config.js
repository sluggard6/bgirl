...
(function () {
     ...
     */
    window.UEDITOR_HOME_URL = "/static/js/lib/ueditor/";
    var URL;
    ...
    window.UEDITOR_CONFIG = {
       ...
       ,imageFieldName:"file_uploader"                   //图片数据的key,若此处修改，需要在后台对应文件修改对应参数
        ...
        //附件上传配置区
        ,fileUrl:"/api/upload"              //附件上传提交地址
        ,filePath:URL + "php/"                   //附件修正地址，同imagePath
        ,fileFieldName:"file_uploader"                    //附件提交的表单名，若此处修改，需要在后台对应文件修改对应参数
         //远程抓取配置区
