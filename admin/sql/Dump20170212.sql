...
INSERT INTO `admin_role_user` VALUES (1,1),(2,2);
...
CREATE TABLE `group` (
  ...
  `modify_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COMMENT='图片分组';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `group` VALUES (1,'aaa','aaa版本',1,'2017-02-12 19:40:29','2017-02-12 11:41:39'),(2,'北包包','北包包',1,'2017-02-12 19:41:53','2017-02-12 11:41:53');
...
CREATE TABLE `group_pic_mapping` (
  ...
  `modify_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='图片分组映射表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2017-02-12 20:33:14
